...
export default function Saldo() {
    ...
    const fetchSaldoBySource = async () => {
      ...
      try {
        ...
        const selected = response.find(
          (item) => item.sumber_id === selectedSource
        );
        if (selected) {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      text: "Data yang terhubung dengan saldo ini akan dihapus secara permanen!",
      icon: "warning",
  ...
  return (
    <div className="relative bg-blue-500 shadow-md border-b border-gray-300 w-full rounded-b-3xl h-[300px] mt-[-15px]">
      <div className="font-poppins text-white text-center pt-8">
        ...
        <div className="text-[48px] font-extrabold mt-1">
        ...
        >
          {dataSaldo.map((item, index) => (
            ...
            >
              ...
              />
              <div>
                <h3 className="text-blue-600 font-bold text-[20px]">
                  {item.nama_sumber}
                </h3>
      ...
      <div className="relative bg-white-500 shadow-md border-b border-gray-300 w-full rounded-3xl h-[600px] mt-[105px] items-center mx-auto">
        <div className="font-poppins text-blue-600 text-left pt-8">
          <div className="text-[28px] font-semibold mt-20 ml-10">
            Tambahkan Sumber Dana Anda{" "}
          </div>
          <form
            onSubmit={async (e) => {
              e.preventDefault();
              ...
              const isDuplicate = dataSaldo.some(
                (item) => item.sumber_id === selectedSourceId
              );
              if (isDuplicate) {
                Swal.fire({
                  icon: "info",
          ...
          >
            <p className="text-black ml-25 mt-6 text-[18px] font-semibold">
              Pilih Sumber Dana :
            </p>

      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            <strong>SiGocengs</strong> adalah platform manajemen keuangan
            pribadi dan keluarga yang berdiri sejak 2024. Aplikasi ini bertujuan
            membantu masyarakat Indonesia dalam mengatur pengeluaran, mencatat
            transaksi, dan mencapai tujuan finansial mereka secara cerdas dan
            praktis.
          </p>
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-700 mt-1">
              Menjadi solusi keuangan digital terpercaya untuk keluarga
              Indonesia.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 mt-1 space-y-1">
              ...
              <li>
                Menyediakan alat pencatatan dan perencanaan keuangan harian yang
                mudah.
              </li>
              <li>
                Memberikan edukasi keuangan bagi seluruh lapisan masyarakat.
              </li>
            </ul>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 justify-items-center">
            {dataTim.map((tim, index) => (
              <div key={index} className="flex flex-col items-center">
                ...
                <p className="text-white text-[18px] font-bold text-center mt-8">

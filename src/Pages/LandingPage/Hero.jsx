  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col-reverse md:flex-row items-center justify-between gap-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg opacity-90 mb-6">
              Try Email Finder. Build your leads database faster with SiGocengs
     ...
     {/* Features */}
      <motion.div
        id="features"
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 max-w-6xl mx-auto pt-16 pb-12"
        initial={{ opacity: 0 }}
      ...
      <div className="py-8 bg-gray-900 text-white">
        <ScrollVelocity
          texts={[
            <>
              <FaMoneyBillWave className="inline-block mr-2 text-blue-300" />
              Kelola keuangan lebih cerdas dengan SiGocengs. Atur anggaran & raih target menabung.
            </>,
            <>
              <FaChartLine className="inline-block mr-2 text-indigo-300" />
